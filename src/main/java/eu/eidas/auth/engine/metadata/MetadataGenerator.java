...
public class MetadataGenerator {
    ...
    private static final Logger LOG = LoggerFactory
	    .getLogger(MetadataGenerator.class.getName());
    ...
    public void initialize(EIDASSAMLEngine engine) throws SAMLEngineException {
        LOG.debug("initialise un Engine ");
        try {
            ...
            LOGGER.info("ERROR : error during initialization from UN samlengine: {}", see.getMessage());
            LOGGER.debug("ERROR : error during initialization from UN samlengine: {}", see);
            throw see;
        }
    }
    ...
    public void initialize(EIDASSAMLEngine spEngine, EIDASSAMLEngine idpEngine) throws SAMLEngineException{
        ...
        try {
            ...
            LOGGER.info("ERROR : error during initialization from DEUX samlengine: {}", see.getMessage());
            LOGGER.debug("ERROR : error during initialization from DEUX samlengine: {}", see);
            throw see;
        }
    }
