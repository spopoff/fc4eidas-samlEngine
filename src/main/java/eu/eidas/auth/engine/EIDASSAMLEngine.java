...
public final class EIDASSAMLEngine extends AbstractSAMLEngine {
	...
	LOG.debug("Generate EIDASAuthnRequest.");
	...
	final Iterator<PersonalAttribute> iterator = authnRequest.getPersonalAttributeList().iterator();
        ...
        LOG.debug("boucle des attributs nb="+authnRequest.getPersonalAttributeList().size());
        while (iterator.hasNext()) {

            final PersonalAttribute attribute = iterator.next();
            LOG.debug("extensionProcessor attribute="+attribute.getName());
        ...
        LOG.debug("Fin validateEIDASAuthnRequest attribute nb="+authnRequest.getPersonalAttributeList().size());
        return authnRequest;
    ...
    private AuthnRequest validateRequestHelper(final byte[] tokenSaml) throws EIDASSAMLEngineException{
        LOG.debug("Validate AuthnRequest extensionProcessor null?"+(extensionProcessor!=null)+" nb extentionProc="+getExtensionProcessors().length);
        ...
        LOG.debug("fin validateRequestHelper samlRequest null?"+(samlRequest==null));
        return samlRequest;
    }
