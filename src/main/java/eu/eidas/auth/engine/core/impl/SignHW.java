...
public final class SignHW extends AbstractSigner {
     ...
     */
    public KeyStore getOwnKeyStore() {
	return ownKeyStore;
    }
     ...
     */
    public void setEidasOwnKeyStore(final KeyStore newkOwnKeyStore) {
	this.ownKeyStore = newkOwnKeyStore;
    }

    /**
     * @see
     * eu.eidas.auth.engine.core.SAMLEngineSignI#init(java.lang.String)
    ...
    /**
     * @see
     * eu.eidas.auth.engine.core.SAMLEngineSignI#sign(SignableSAMLObject tokenSaml)
    ...
    /**
     * @see
     * eu.eidas.auth.engine.core.SAMLEngineSignI#validateSignature(SignableSAMLObject, String)
	...
	try {
	    ...
	    for (final Enumeration<String> e = ownKeyStore.aliases(); e
		    .hasMoreElements();) {
		aliasCert = e.nextElement();
		final BasicX509Credential credential = new BasicX509Credential();
		certificate = (X509Certificate) ownKeyStore
     ...
     * }
     * OwnKeyStore = KeyStore.getInstance(properties.getProperty(KEYSTORE_TYPE))
     */
