...
public class EncryptionSW extends AbstractSAMLEngineModule implements SAMLEngineEncryptionI {
    ...
    public void init(Properties propsConf) throws SAMLEngineException {
        try {
            ...
            LOG.error("Error init method");
            throw new SAMLEngineException(EIDASErrors.SAML_ENGINE_CONFIGURATION_ERROR.errorCode(), EIDASErrors.SAML_ENGINE_CONFIGURATION_ERROR.errorMessage(), e);
        }
    ...
    @Override
    public Response encryptSAMLResponse(Response authResponse, String destinationCountryCode, String requestIssuer, String messageFormat) throws SAMLEngineException {
        BasicX509Credential credential=(BasicX509Credential)getMetadataEncryptionCredential(requestIssuer, messageFormat);
        if(credential==null && isEncryptionEnable(destinationCountryCode)) {
            ...
            if (responseToPointIssuer != null && !responseToPointIssuer.isEmpty()) {
                try {
                    ...
                    if (!find) {
                        throw new SAMLEngineException(EIDASErrors.SAML_ENGINE_INVALID_CERTIFICATE.errorCode(), EIDASErrors.SAML_ENGINE_INVALID_CERTIFICATE.errorMessage());
                    }
                    ...
                    throw new SAMLEngineException(EIDASErrors.SAML_ENGINE_INVALID_KEYSTORE.errorCode(), EIDASErrors.SAML_ENGINE_INVALID_KEYSTORE.errorMessage(), kse);
                }catch (Exception e) {
    ...
    private final void loadCryptServiceProvider() throws SAMLEngineException {
        ...
        try {
            ...
            throw new SAMLEngineException(EIDASErrors.SAML_ENGINE_LOAD_PROVIDER.errorCode(),EIDASErrors.SAML_ENGINE_LOAD_PROVIDER.errorMessage(), e);
        }
    }
    ...
    private final void loadKeystore() throws EIDASSAMLEngineException {
        ...
        try {
            ...
            throw new EIDASSAMLEngineException(
                    EIDASErrors.SAML_ENGINE_INVALID_KEYSTORE.errorCode(),
    ...
    private Credential getMetadataEncryptionCredential(String metadataUrl, String messageFormat) throws SAMLEngineException{
        Credential credential=null;
